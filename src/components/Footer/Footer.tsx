    ...
    <footer className="bg-[var(--green-main)] border-t border-[var(--green-main)] px-6 py-14 text-[var(--cream-main)]">
      <div className="section-width mx-auto flex flex-col gap-8 items-center">
        ...
        <div>
          ...
          <p className="mt-1.5 text-[var(--yellow-main)] font-light text-base md:text-lg leading-relaxed max-w-xs">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            href="/oferta"
            className="text-xs md:text-base text-[var(--yellow-text)] hover:text-[var(--yellow-main)] transition-colors underline underline-offset-2"
          >
            Оферта
          </a>
          <a
        ...
        <div className="flex items-center justify-between gap-4 pt-4 border-t border-matcha-800">
          <p className="text-xs text-[var(--cream-main)]">
