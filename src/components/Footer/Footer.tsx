...
export default function Footer() {
  return (
    <footer className="bg-[var(--green-main)] border-t border-[var(--green-main)] px-6 py-14 text-[var(--cream-main)]">
      <div className="section-width mx-auto flex flex-col gap-8 items-start md:items-center">
        {/* Text block 1 — brand */}
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-20">
          ...
          {/* Text block 2 — legal */}
          <div className="text-[var(--cream-main)] font-light text-xs md:text-base leading-relaxed ">
